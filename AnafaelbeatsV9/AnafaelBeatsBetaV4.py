...
def get_top_artists(time_period):
    ...
    headers = {
        "X-RapidAPI-Key": "3d7da4c793msh13e60ea3130926ap1fb16cjsnd51dabd3c916",
...
#--------------------------------------game----------------------
dataframe= pd.read_csv("AnafaelbeatsV9/recurso/datos_artistas.csv")
Answer = ""
Puntos = 0
